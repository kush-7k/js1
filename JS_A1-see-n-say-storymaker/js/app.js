...
let buttonThird = document.querySelector("#third")
let buttonFourth = document.querySelector("#fourth")
let buttonFifth = document.querySelector("#fifth")
let storyCreator = document.querySelector("#create")
...
Now, when user click on the Creare story button the storyCreator listener activate and use 
